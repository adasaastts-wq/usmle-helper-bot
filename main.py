...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "🧩 Anki decks & flashcards\n"
        "📚 UWorld Qbank strategies\n"
        "📖 High-yield book recommendations\n"
        "🎥 Boards & Beyond resources\n"
        "🗓 Study schedules, tips & FAQs\n\n"
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/anki - Get Anki decks by system\n"
        "/uworld - UWorld strategies\n"
        "/books - High-yield book recommendations\n"
        "/beyond - Boards & Beyond guidance\n"
        "/schedule - Study schedule tips\n"
...
async def uworld(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "3️⃣ Annotate key info into notes/Anki\n"
...
async def schedule(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🗓 Study schedule tips:\n"
        "• 6 months: 2–3h/day content review\n"
        "• 3 months: 5–6h/day + timed Qbank\n"
        "• 1 month: Full-time review, NBME every 7 days"
    )
